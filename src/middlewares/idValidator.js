            ...
            switch (_a.label) {
                ...
                case 2:
                    ...
                    if (!exists) {
                        return [2 /*return*/, res.status(400).json({
                                error: true,
                                message: "Nenhum registro com o id ".concat(value, " fora encontrado em ").concat(fieldObj.tableName),
                            })];
                    }
                    if (equal) {
                ...
                case 4:
                    if (equal) {
                        toCompare = arr.map(function (item) { return JSON.stringify(item); });
                        set = new Set(toCompare);
